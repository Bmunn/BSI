function [LClocs,BNMlocs,Baselocs] = LcBnmPkTime(lc_ts,bnm_ts,dt)


%Takes in the LC and BNM activity, and finds the peaks times that satisfy the
%phasic increase followed by a significant peak 
...
%Entries near the end/beginning of the subject within a dt (but factoring in acc
%peak occurring 10 tr post must be at least 10 TR)
